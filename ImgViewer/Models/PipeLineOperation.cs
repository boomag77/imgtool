...
namespace ImgViewer.Models
{
...

    {
        ...
        public PipelineOperation(PipelineOperationType type,
                                    ProcessorCommand procCommand,
                                    string displayName,
                                    string actionLabel,
                                    IEnumerable<PipeLineParameter> parameters,
                                    Action<PipelineOperation>? execute = null)
        {
        ...
        public bool IsBreakpoint
        {
            ...
            set
            {
                ...
                _isBreakpoint = value;
                OnPropertyChanged();
                OnPropertyChanged(nameof(IsCheckpoint));
            }
        }
        ...
        public string BreakpointName
        {
            get
            {
                return _breakpointName ?? string.Empty;
            }
            set
            {
